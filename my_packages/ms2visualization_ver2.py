...
from my_packages.peaktools import modified_cosine,cosine,neutral_loss
from my_packages.functions import mgf_process, get_mgf_info, get_edb_info, get_isdb_info
